...
class Net(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv3 = nn.Conv2d(64, 96, 3) # Output (128, 52, 52) # After pool, output (128, 26, 26)
        self.drop3 = nn.Dropout(p=0.2)
                
        self.conv4 = nn.Conv2d(96, 128, 3) # Output (256, 24, 24)# Maxpooled Output = (256, 12, 12)
        self.drop4 = nn.Dropout(p=0.2)        
        
        self.conv5 = nn.Conv2d(128, 256, 3) # Output = (512, 10, 10)# Maxpooled Output = (512, 5, 5)
        self.drop5 = nn.Dropout(p=0.2)
        
        self.fc6 = nn.Linear(256*5*5, 136)
